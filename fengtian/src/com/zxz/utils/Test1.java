...
public class Test1 {
	...
	public static void main(String[] args) {
		...
		//0,52,53,72,80,96,100,104,120,124,125,130,132,133   0   108,112,116,
				int intArrayForCard[] = {
				/*0,1,53,54,55,96,
				100,104,
				120,121,122,128,129,130};*/		
						101,117,118,122,124,127,133,134};		
		...
		boolean isCanHu = test.checkHuPai(intArrayForHand, intArrayForPeng, intArrayForGang, hunId, true, true);
