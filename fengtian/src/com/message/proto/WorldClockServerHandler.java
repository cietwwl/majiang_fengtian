...
public class WorldClockServerHandler extends SimpleChannelInboundHandler<command> {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
		...
		builder.setName(outJsonObject.toString());
		ctx.write(builder.build());
    	ctx.flush();
//	    ctx.channel().attr(AttributeKey.<String>valueOf("User")).set("19999");
    }
